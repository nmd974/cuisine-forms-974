...
<?php /*
  require_once( __ROOT__.'/src/formulaires/formAjoutAtelier.php');
    function validationAjout($data, $image_upload):string {
      $inputRequired =[$_POST["titre"], $_POST["description"],];
      $inputNumber =[$_POST["prix"],  $_POST[ "duree"], $_POST[ "nombre_places" ], $_POST [ "heur_debut"]];
      $inputDate = ["date_debut"];
      $validationForms = false;
      foreach ($inputRequired as $input){
        if($data[$input] == ""){
          $validationForms = false;
