...
?>
    <?php require_once(__ROOT__ . '/src/includes/formulaires/formModifAtelier.php'); // On inclut la structure du formulaire en récupérant le fichier "formModifAtelier"
    ?>
