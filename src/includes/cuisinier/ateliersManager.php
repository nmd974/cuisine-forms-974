                    ...
                    <?php if ($atelier['proprietaire'] == $_SESSION['id']) : ?>
                        <div class="card">
                            <div class="card-header d-flex align-items-center">
                                <button class="btn btn-link btn-block text-left" type="button" data-toggle="collapse" data-target="#collapse_<?= $atelier['id'] ?>" aria-expanded="true" aria-controls="collapse_<?= $atelier['id'] ?>">
                                ...
                                <div class="custom-control custom-switch" id="<?= $atelier['id'] ?>">
                                    ...
                                    <label class="custom-control-label" for="<?= $atelier['id'] ?>" id="<?php echo 'labelswitch_' . $atelier['id'] ?>">
                                ...
                                <div class="card w-100 card-manager">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex w-100 justify-content-between align-items-center mt-5">
                                            <p class="card-text"><small class="text-muted"><?= !$atelier['modifie'] ? "Ajouté le :" : "Modifié le :" ?><?= $atelier['date_ajout'][1] ?></small>
                                            </p>
                                            <a href="../pages/pageAtelier.php?id=<?= $atelier['id'] ?>" class="btn btn-primary">Modifier</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
